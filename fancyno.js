...
console.log(timestampInMilliseconds);
        ...
        const requestTypefancy = document.getElementById("requestTypefancy").value;
        const telecomProviderfancy = document.getElementById("telecomProviderfancy").value;

        // Check if all fields are filled and selected
        if (name && phone && address && pincode && requestTypefancy && telecomProviderfancy) {
            const userUid = uid;

                const userPath2 = 'fancyRequests/' + timestampInMilliseconds;
                ...
                const userData2 = {
                    ...
                    Address: address,
                    Pincode: pincode,
                    "Request Type": requestTypefancy,
                    Key: timestampInMilliseconds,
                    "Telecom Provider": telecomProviderfancy
                };
